...
title = AI Kalori Sihirbazı

# (str) Package name
package.name = aikalorisihirbazi
...
#android.permissions = INTERNET, READ_EXTERNAL_STORAGE, WRITE_EXTERNAL_STORAGE android.permission.INTERNET, (name=android.permission.WRITE_EXTERNAL_STORAGE;maxSdkVersion=18)
...
#       [app]
#       title = AI Kalori Sihirbazı # This is not a comment, it is part of the title.
#
#   Warning: Indented text is treated as a multiline string - i.e.
#       [app]
#       title = AI Kalori Sihirbazı
#          package.name = aikalorisihirbazi # This is all part of the title.
#
...
#
#       [app@demo]
#       title = AI Kalori Sihirbazı (demo)
#
