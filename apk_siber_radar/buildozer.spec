...
#       [app]
#       title = Siber Radar # This is not a comment, it is part of the title.
#
#   Warning: Indented text is treated as a multiline string - i.e.
#       [app]
#       title = Siber Radar
#          package.name = siberradar # This is all part of the title.
#
